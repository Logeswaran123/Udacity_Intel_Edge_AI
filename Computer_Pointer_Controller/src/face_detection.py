...
class FaceDetectionClass:
    ...
    def predict(self, image):
        ...
        results = self.net.infer({self.input_name: p_image})
        faces_coordinates = self.preprocess_output(results, image)
        ...
        first_face_coordinates = faces_coordinates[0]
        cropped_face = image[first_face_coordinates[1]:first_face_coordinates[3],
                             first_face_coordinates[0]:first_face_coordinates[2]]

        return first_face_coordinates, cropped_face
