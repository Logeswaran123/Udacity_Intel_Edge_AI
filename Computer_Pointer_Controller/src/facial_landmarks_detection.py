...
class FacialLandmarksClass:
    ...
    def predict(self, image):
        ...
        results = self.net.infer(inputs={self.input_name: p_image})
        output  = self.preprocess_output(results, image)
        
        # Process output and send cropped image, coordinates
        left_eye_x_min = output['left_eye_x_coordinate'] - 15
        left_eye_x_max = output['left_eye_x_coordinate'] + 15
        left_eye_y_min = output['left_eye_y_coordinate'] - 15
        left_eye_y_max = output['left_eye_y_coordinate'] + 15

        right_eye_x_min = output['right_eye_x_coordinate'] - 15
        right_eye_x_max = output['right_eye_x_coordinate'] + 15
        right_eye_y_min = output['right_eye_y_coordinate'] - 15
        right_eye_y_max = output['right_eye_y_coordinate'] + 15
